...
driver.set_window_position(3841, 0)
driver.maximize_window()
# 设置left超过屏幕尺寸，使浏览器在副屏幕上启动，调试时就不会遮挡编码界面啦
url = 'https://dnf.qq.com/lbact/a20220421jhy/index.html'
...
def login():
    driver.get(url)
    click('//*[@id="dologin"]', True)
    time.sleep(2)
    click('/html/body/div[1]/div[2]/div/div[2]/ul[2]/li[1]/a', True)
    time.sleep(1)
    click('//*[@id="showAlert"]/div/a', True)
